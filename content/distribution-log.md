# Kimi K3 Distribution Log

This file tracks useful off-site distribution assets for the Kimi K3 OpenAI-compatible API guide.

The goal is not to create thin backlinks. Each destination should contain a useful tutorial, code example, or documentation-style article that helps developers test Kimi K3 through `https://lizh.ai/v1`.
...
| Priority | Platform | Action | Dependency |
| --- | --- | --- | --- |
...
- Keep lizh.ai described as an independent OpenAI-compatible API gateway.
- Do not imply official Moonshot/Kimi affiliation.
- Include at least one concrete setup path or code example per article.
- Prefer one or two natural links over dense link stuffing.
- Track published URLs here before moving to the next platform.
