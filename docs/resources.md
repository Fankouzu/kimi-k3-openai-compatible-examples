...
Use these links for deeper setup examples and related references.

## Code examples

[GitHub examples repository](https://github.com/Fankouzu/kimi-k3-openai-compatible-examples)
...
- [Create API keys](https://lizh.ai/keys)
- [Model pricing](https://lizh.ai/pricing)
